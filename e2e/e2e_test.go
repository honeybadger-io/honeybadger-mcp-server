...
func TestListTools(t *testing.T) {
	...
	expectedToolCount := 39 // create_alarm, create_check_in, create_dashboard, create_fault_comment, create_project, delete_alarm, delete_check_in, delete_dashboard, delete_fault_comment, delete_project, get_alarm, get_alarm_history, get_check_in, get_dashboard, get_fault_comment, get_fault, get_fault_counts, get_reference, get_project, get_project_integrations, get_project_occurrence_counts, get_project_report, list_alarms, list_check_ins, list_dashboards, list_fault_affected_users, list_fault_comments, list_fault_notices, list_faults, list_projects, list_streams, query_insights, search_tools, update_alarm, update_check_in, update_dashboard, update_fault_comment, update_fault, update_project
...
func TestListToolsReadOnly(t *testing.T) {
	...
	expectedToolCount := 23 // get_alarm, get_alarm_history, get_check_in, get_dashboard, get_fault_comment, get_fault, get_fault_counts, get_reference, get_project, get_project_integrations, get_project_occurrence_counts, get_project_report, list_alarms, list_check_ins, list_dashboards, list_fault_affected_users, list_fault_comments, list_fault_notices, list_faults, list_projects, list_streams, query_insights, search_tools
	if len(tools) != expectedToolCount {
	...
	expectedReadOnlyTools := []string{"get_alarm", "get_alarm_history", "get_check_in", "get_dashboard", "get_fault_comment", "get_fault", "get_fault_counts", "get_reference", "get_project", "get_project_integrations", "get_project_occurrence_counts", "get_project_report", "list_alarms", "list_check_ins", "list_dashboards", "list_fault_affected_users", "list_fault_comments", "list_fault_notices", "list_faults", "list_projects", "list_streams", "query_insights", "search_tools"}
	...
	destructiveTools := []string{"create_alarm", "create_check_in", "create_dashboard", "create_fault_comment", "create_project", "delete_alarm", "delete_check_in", "delete_dashboard", "delete_fault_comment", "delete_project", "update_alarm", "update_check_in", "update_dashboard", "update_fault_comment", "update_fault", "update_project"}
