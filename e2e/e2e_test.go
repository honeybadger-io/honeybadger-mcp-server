...
func TestListTools(t *testing.T) {
	...
	expectedToolCount := 41 // create_alarm, create_integration, create_check_in, create_dashboard, create_project, create_project_key, delete_alarm, delete_integration, delete_check_in, delete_dashboard, delete_project, delete_project_key, get_alarm, get_alarm_history, get_integration, get_check_in, get_dashboard, get_fault, get_fault_counts, get_reference, get_project, get_project_integrations, get_project_occurrence_counts, list_alarms, list_check_ins, list_dashboards, list_fault_affected_users, list_fault_notices, list_faults, list_project_keys, list_projects, list_streams, query_insights, search_tools, update_alarm, update_integration, update_check_in, update_dashboard, update_fault, update_project, update_project_key
	...
	expectedTools := []string{"create_alarm", "create_integration", "create_check_in", "create_dashboard", "create_project", "create_project_key", "delete_alarm", "delete_integration", "delete_check_in", "delete_dashboard", "delete_project", "delete_project_key", "get_alarm", "get_alarm_history", "get_integration", "get_check_in", "get_dashboard", "get_fault", "get_fault_counts", "get_reference", "get_project", "get_project_integrations", "get_project_occurrence_counts", "list_alarms", "list_check_ins", "list_dashboards", "list_fault_affected_users", "list_fault_notices", "list_faults", "list_project_keys", "list_projects", "list_streams", "query_insights", "search_tools", "update_alarm", "update_integration", "update_check_in", "update_dashboard", "update_fault", "update_project", "update_project_key"}
...
func TestListToolsReadOnly(t *testing.T) {
	...
	expectedToolCount := 22 // get_alarm, get_alarm_history, get_integration, get_check_in, get_dashboard, get_fault, get_fault_counts, get_reference, get_project, get_project_integrations, get_project_occurrence_counts, list_alarms, list_check_ins, list_dashboards, list_fault_affected_users, list_fault_notices, list_faults, list_project_keys, list_projects, list_streams, query_insights, search_tools
	if len(tools) != expectedToolCount {
	...
	expectedReadOnlyTools := []string{"get_alarm", "get_alarm_history", "get_integration", "get_check_in", "get_dashboard", "get_fault", "get_fault_counts", "get_reference", "get_project", "get_project_integrations", "get_project_occurrence_counts", "list_alarms", "list_check_ins", "list_dashboards", "list_fault_affected_users", "list_fault_notices", "list_faults", "list_project_keys", "list_projects", "list_streams", "query_insights", "search_tools"}
