...
func TestListTools(t *testing.T) {
	...
	expectedToolCount := 9 // create_project, delete_project, get_project, get_project_integrations, get_project_occurrence_counts, get_project_report, list_projects, ping, update_project
	...
	expectedTools := []string{"create_project", "delete_project", "get_project", "get_project_integrations", "get_project_occurrence_counts", "get_project_report", "list_projects", "ping", "update_project"}
