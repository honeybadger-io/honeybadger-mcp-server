...
func TestListTools(t *testing.T) {
	...
	expectedToolCount := 27 // create_alarm, create_dashboard, create_project, delete_alarm, delete_dashboard, delete_project, get_alarm, get_alarm_history, get_dashboard, get_fault, get_fault_counts, get_reference, get_project, get_project_integrations, get_project_occurrence_counts, get_project_report, list_alarms, list_dashboards, list_fault_affected_users, list_fault_notices, list_faults, list_projects, query_insights, search_tools, update_alarm, update_dashboard, update_project
	...
	expectedTools := []string{"create_alarm", "create_dashboard", "create_project", "delete_alarm", "delete_dashboard", "delete_project", "get_alarm", "get_alarm_history", "get_dashboard", "get_fault", "get_fault_counts", "get_reference", "get_project", "get_project_integrations", "get_project_occurrence_counts", "get_project_report", "list_alarms", "list_dashboards", "list_fault_affected_users", "list_fault_notices", "list_faults", "list_projects", "query_insights", "search_tools", "update_alarm", "update_dashboard", "update_project"}
...
func TestListToolsReadOnly(t *testing.T) {
	...
	expectedToolCount := 18 // get_alarm, get_alarm_history, get_dashboard, get_fault, get_fault_counts, get_reference, get_project, get_project_integrations, get_project_occurrence_counts, get_project_report, list_alarms, list_dashboards, list_fault_affected_users, list_fault_notices, list_faults, list_projects, query_insights, search_tools
	if len(tools) != expectedToolCount {
	...
	expectedReadOnlyTools := []string{"get_alarm", "get_alarm_history", "get_dashboard", "get_fault", "get_fault_counts", "get_reference", "get_project", "get_project_integrations", "get_project_occurrence_counts", "get_project_report", "list_alarms", "list_dashboards", "list_fault_affected_users", "list_fault_notices", "list_faults", "list_projects", "query_insights", "search_tools"}
